...
class EditProfileViewController: UIViewController {
    ...
    let saveButton = Button(image: UIImage(systemName: ""), label: "save", btnTitleColor: #colorLiteral(red: 0.9803921569, green: 0.2901960784, blue: 0.04705882353, alpha: 1), backgroundColor: .clear, radius: 0, imageColor: .clear, font: UIFont())
